...
import com.example.adminfoodorderingapp.databinding.ActivityLoginBinding
import com.example.adminfoodorderingapp.model.UserM
import com.example.adminfoodorderingapp.sqlitedatabase.UserDatabaseHelper1

class LoginActivity : AppCompatActivity() {

    private lateinit var dbHelper: UserDatabaseHelper1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dbHelper = UserDatabaseHelper1(this)
